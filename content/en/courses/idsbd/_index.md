...
|  4  | 大数据处理基础 Big Data Analytics Fundamentals[2] 数据预处理                                        | [{{% staticref "uploads/idsbd/2022_Chp3_数据采集.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         | 扩展学习：   |
| 5  | 大数据处理基础 Big Data Analytics Fundamentals[3] 数据探索性分析                                      | [{{% staticref "uploads/idsbd/2022_Chp3_数据采集.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         |         |
|  6  | 大数据分析算法[1]（聚类） Big Data Analytics Algorithms (Clustering)                               | [{{% staticref "uploads/idsbd/2022_Chp3_数据采集.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         | 扩展学习：   |
|  7  | 大数据分析算法[2]（分类） Big Data Analytics Algorithms (Classification)                           | [{{% staticref "uploads/idsbd/2022_Chp3_数据采集.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         |         |
