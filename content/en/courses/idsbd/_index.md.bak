...
## Course Description
随着 IT存储、处理、计算和传感技术的进步，大数据已成为一种新的生活常态。计算机和传感设备逐渐能够捕获和分析来自各个领域的各种大规模数据——人、行为、信息、设备、传感器、生物信号、金融、车辆、神经学等。几乎所有行业正在迎接大数据的挑战，并希望挖掘有价值的信息以获得洞察力以解决他们的挑战。《数据科学与大数据技术专业导论》是数据科学与大数据技术专业开设的学科基础课和先导课程。本课程旨在介绍数据科学和大数据分析的基础知识，包括数据分析的常用技术、发展前沿和应用案例，以及“大数据”的算法和标准工具，同时通过设计一系列的实践课程，使学生初步掌握使用数据分析手段，提升解决实际应用问题的能力，将科学的方法研究应用到社会需求中，以应对各种现实世界的挑战。
