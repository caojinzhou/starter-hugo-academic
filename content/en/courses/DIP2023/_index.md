...
|----- |:------------:|:--------------------------------|------------------------------------------------------------------------------|--------------------------------------------|
|  1   |  数字图像处理初步与基本运算（基本运算、几何变换、缩放、旋转、灰度变换）               | [{{% staticref "uploads/DIP2023/实验1数字图像处理初步与基本运算.pdf" "newtab" %}}实验1{{% /staticref %}}]；[{{% staticref "uploads/DIP2023/images.rar" "newtab" %}}实验图像{{% /staticref %}}]|0x/xx/23     |【[班1](https://send2me.cn/-jMckXw6/TiS8Cupny4bn9Q) 】【[班2](https://send2me.cn/w5mCwkEC/QKqLRQ4pZ8x3wQ)】 |
