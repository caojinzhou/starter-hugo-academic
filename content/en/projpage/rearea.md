...
<div class="ai4city-project-directions">
  <article class="is-sensing">
    ...
    <div>
      ...
      <ul>
        <li>Multi-source fusion</li>
        <li>Urban representation</li>
        <li>Dynamic function sensing</li>
      </ul>
    </div>
  </article>
  <article class="is-model">
    ...
    <div>
      ...
      <ul>
        ...
        <li>Urban foundation models</li>
        <li>Generation and prediction</li>
      </ul>
    </div>
  </article>
  <article class="is-geoai">
    ...
    <div>
      ...
      <ul>
        <li>Geo-AI methods</li>
        <li>Social sensing</li>
        <li>Spatial decision-making</li>
      </ul>
    </div>
  </article>
