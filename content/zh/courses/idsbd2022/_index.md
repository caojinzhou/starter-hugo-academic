---
title: 📊 IB00095 (2022)Introducation to Data Science and Big Data（数据科学与大数据导论）
...
|  2   | 数据科学基础  Data Science Fundamentals                                                       | [{{% staticref "uploads/idsbd/2022-Chp2-数据科学导言.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                       |                                                                                                    |
|  3   | 大数据处理基础 Big Data Analytics Fundamentals[1] 数据采集，数据模型                                    | [{{% staticref "uploads/idsbd/2022-Chp3-(1)数据采集.pdf" "newtab" %}}数据采集Slides{{% /staticref %}}];[{{% staticref "uploads/idsbd/2022-Chp3-(2)数据模型类型.pdf" "newtab" %}}数据模型Slides{{% /staticref %}}] |                                                                                                    |
|  4  | 大数据处理基础 Big Data Analytics Fundamentals[2] 数据预处理                                        | [{{% staticref "uploads/idsbd/2022-Chp3-(3)数据预处理.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         | 扩展学习内容：[{{% staticref "uploads/idsbd/2022-Chp3-(3)数据预处理 扩展学习内容.pdf" "newtab" %}}Slides{{% /staticref %}}] |
| 5  | 大数据处理基础 Big Data Analytics Fundamentals[3] 数据探索性分析                                      | [{{% staticref "uploads/idsbd/2022-Chp3-数据探索性分析.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         |                                                                                                    |
|  6  | 大数据分析算法[1]（聚类） Big Data Analytics Algorithms (Clustering)                               | [{{% staticref "uploads/idsbd/2022-Chp4-机器学习算法-聚类.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         | 扩展学习内容：[{{% staticref "uploads/idsbd/2022-Chp4-机器学习算法-聚类 扩展学习内容.pdf" "newtab" %}}Slides{{% /staticref %}}] |
|  7  | 大数据分析算法[2]（分类） Big Data Analytics Algorithms (Classification)                           | [{{% staticref "uploads/idsbd/2022-Chp4-机器学习算法-分类.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                         |                                                                                                    |
|  8  | 大数据分析算法[3]（回归、关联分析） Big Data Analytics Algorithms (Regression and Association Analysis) |[{{% staticref "uploads/idsbd/2022-Chp4-机器学习算法-回归 关联.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                                                                                                                 |                                                                                                    |
|  9 | 大数据可视化 Big Data Visualization                                                           | [{{% staticref "uploads/idsbd/2022-Chp6-数据可视化.pdf" "newtab" %}}Slides{{% /staticref %}}]                                                                                                                                                                                |                                                                                                    |
...
|  7   | 聚类和分类算法实验                        | [{{% staticref "uploads/idsbd/实验2.zip" "newtab" %}}实验二{{% /staticref %}}]   | 【[周四班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/1258a2fc23dc4348ac432cc2bf836659/submitv2)】   【[周一班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/54dd0b2ab4974b5fbc56c656968f1c29/submitv2)】                                                                   |
|  8  | 回归和关联分析算法实验                    | [{{% staticref "uploads/idsbd/实验3.ipynb" "newtab" %}}实验三{{% /staticref %}}] | 【[周四班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/6f07d31e2fdb4b2d8e5d18e01436fae5/submitv2)】【[周一班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/5d7d7b8dfc594793bcb9a307b5238e32/submitv2)】 |
|  9  | 数据可视化实验                   | [{{% staticref "uploads/idsbd/实验4.zip" "newtab" %}}实验四{{% /staticref %}}]   |【[周四班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/a2b80956e30d428fb7a1f70925c24833/submitv2)】【[周一班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/898d87653c69439385d23da715916bc5/submitv2)】|
|  10  | 数据爬虫操作实验             |  [{{% staticref "uploads/idsbd/实验5.zip" "newtab" %}}实验五{{% /staticref %}}]                                                                            |  【[周四班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/684922de9b894b658597c33ec6464703/submitv2)】 【[周一班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/3184fa89b508413284be6a4a6a26d978/submitv2)】                                                                                                                                                                                                                                                                                  |
|  11  | 城市大数据分析与实践[1]                |  [{{% staticref "uploads/idsbd/实验6.rar" "newtab" %}}实验六{{% /staticref %}}]                                                                            |                                                                                                                                                                                                                                                                                     |
|  12  | 城市大数据分析与实践[2]   |  [{{% staticref "uploads/idsbd/实验7.zip" "newtab" %}}实验七{{% /staticref %}}]                                                                            |  【[周四班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/bc439ea8b07a42f58238fe467417637f/submitv2)】【[周一班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/c0b1c1c116604f13ae4e25d474785eaa/submitv2)】                                                                                                                                                                                                                                                                                   |
|  13  | 图数据计算实验[1]                  |                                                                             |                                                                                                                                                                                                                                                                                     |
|  14  | 图数据计算实验[2]| [{{% staticref "uploads/idsbd/实验8.rar" "newtab" %}}实验八{{% /staticref %}}]                                                                            | 【[周四班上传点击此处](https://workspace.jianguoyun.com/inbox/collect/99ff3d8cbd14482ca16397c0ab0dc947/submitv2)】  【[周一班上传点击此处](https://send2me.cn/FSZALa4R/RpaRS9dEgyefOg==)】                                                                                                                                                                                                                                                                                  |
