...
|----- |:------------:|:--------------------------------|------------------------------------------------------------------------------|--------------------------------------------|
|  1   | 02/23/23     | 绪论及图像处理软件基础 {{% staticref "uploads/DIP2023/2023_DIP_Ch1_绪论及图像处理软件基础.pdf" "newtab" %}}(Slides){{% /staticref %}}+数字图像处理基础 {{% staticref "uploads/DIP2023/2023_DIP_Ch2_数字图像处理基础.pdf" "newtab" %}}(Slides){{% /staticref %}}（3）               | Matlab安装与初步|                                            |
|  2   | 03/02/23     |数字图像的基本运算{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch3_数字图像的基本运算.pdf" "newtab" %}}(Slides){{% /staticref %}}                |         |                                            |
|  3   | 03/09/23     | 空间域图像增强 [1]                 |实验1                                                 |                                            |
|  4   | 03/16/23     | 空间域图像增强 [2] {{% staticref "uploads/DIP2023_slides/2023_DIP_Ch4_空间域图像增强.pdf" "newtab" %}}(Slides){{% /staticref %}}                    |  实验2                                                                            |                |
|  5   | 05/23/23     | 频率域图像增强{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch5_频率域图像增强.pdf" "newtab" %}}(Slides){{% /staticref %}}                    |                                                                              |                                            |
|  6   | 03/30/23     | 图像复原与重建 [1]                |实验3                                                                              |                                            |
|  7   | 04/06/23     | 图像复原与重建 [2]{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch6_图像复原与重建.pdf" "newtab" %}}(Slides){{% /staticref %}}               | |                                            |
|  8   | 04/13/23     | 图像压缩 [1]               |实验4         |                                            |
|  9   | 04/20/22     | 图像压缩 [2]{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch7_图像压缩.pdf" "newtab" %}}(Slides){{% /staticref %}}                        |                                                                              |                                            |
|  10  | 04/27/22     | 图像分割 [1]                    |实验5                                                                              |                |
|  11  | 05/04/22     | 图像分割 [2]{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch8_图像分割.pdf" "newtab" %}}(Slides){{% /staticref %}}                    |                                                                              |                                            |
|  12  | 05/11/22     | 彩色图像处理 [1]                |实验6                                                                              |                                            |
|  13  | 05/18/22     | 彩色图像处理 [2]{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch9_彩色图像处理.pdf" "newtab" %}}(Slides){{% /staticref %}}                |                                                                              |             |
|  14  | 05/25/22     | 图像形态学处理{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch10_图像形态学处理.pdf" "newtab" %}}(Slides){{% /staticref %}}                  |实验7                                                                              |                                            |
|  15  | 06/01/22     | 图像表示与描述 [1]                  |                                                                              |   |
|  16  | 06/08/22     | 图像表示与描述 [2]{{% staticref "uploads/DIP2023_slides/2023_DIP_Ch11_图像表示与描述.pdf" "newtab" %}}(Slides){{% /staticref %}}                    |实验8                                                                              | |
|  17  | 06/15/22     | 大作业汇报展示                   |                                                                              |           |
|  18  | 06/22/22     | 端午节假期                      |                                                                              |          |
...
|----- |:------------:|:--------------------------------|------------------------------------------------------------------------------|--------------------------------------------|
|  1   |  数字图像处理初步与基本运算（基本运算、几何变换、缩放、旋转、灰度变换）               | [{{% staticref "uploads/DIP2023/实验1数字图像处理初步与基本运算.pdf" "newtab" %}}实验1{{% /staticref %}}]；[{{% staticref "uploads/DIP2023/images.rar" "newtab" %}}实验图像{{% /staticref %}}]|0x/xx/23     |【[班1]() 】【[班2]()】 |
