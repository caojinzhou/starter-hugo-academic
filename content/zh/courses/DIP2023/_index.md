...
|  2   | 03/02/23     |数字图像的基本运算{{% staticref "uploads/DIP2023/2023_DIP_Ch3_数字图像的基本运算.pdf" "newtab" %}}(Slides){{% /staticref %}}                |         |                                            |
|  3   | 03/09/23     | 空间域图像增强 [1]                 |实验1                                                 |                                            |
|  4   | 03/16/23     | 空间域图像增强 [2] {{% staticref "uploads/DIP2023/2023_DIP_Ch4_空间域图像增强.pdf" "newtab" %}}(Slides){{% /staticref %}}                    |  实验2                                                                            |                |
|  5   | 05/23/23     | 频率域图像增强{{% staticref "uploads/DIP2023/2023_DIP_Ch5_频率域图像增强.pdf" "newtab" %}}(Slides){{% /staticref %}}                    |                                                                              |                                            |
|  6   | 03/30/23     | 图像复原与重建 [1]                |实验3                                                                              |                                            |
|  7   | 04/06/23     | 图像复原与重建 [2]{{% staticref "uploads/DIP2023/2023_DIP_Ch6_图像复原与重建.pdf" "newtab" %}}(Slides){{% /staticref %}}               | |                                            |
|  8   | 04/13/23     | 图像压缩 [1]               |实验4         |                                            |
|  9   | 04/20/22     | 图像压缩 [2]{{% staticref "uploads/DIP2023/2023_DIP_Ch7_图像压缩.pdf" "newtab" %}}(Slides){{% /staticref %}}                        |                                                                              |                                            |
...
|  2   |  空间域图像增强（直方图变换、空域滤波[均值、中值、锐化]）               | [{{% staticref "uploads/DIP2023/实验2 图像空间域图像增强.pdf" "newtab" %}}实验2{{% /staticref %}}]|0x/xx/23     |【[班1]() 】【[班2]()】 |
|  3   |  频率域图像增强（图像的傅立叶变换、低通滤波、高通滤波）               | [{{% staticref "uploads/DIP2023/实验3 图像频率域图像增强.pdf" "newtab" %}}实验3{{% /staticref %}}]|0x/xx/23     |【[班1]() 】【[班2]()】 |
|  4   |  图像复原与重建（生成运动模糊图像、逆滤波和维纳滤波）                        | [{{% staticref "uploads/DIP2023/xx.docx" "newtab" %}}实验4{{% /staticref %}}];[{{% staticref "uploads/DIP2023/image_e2.zip" "newtab" %}}图像数据{{% /staticref %}}]                                                                             |0x/xx/23     |【[班1]() 】【[班2]()】|
